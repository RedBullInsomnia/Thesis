...
elseif t < 0.2
    ...
    % Feet
    instructions(5,:) = [double(h.right_leg_joints(5)), degtorad(-120)];
    instructions(6,:) = [double(h.left_leg_joints(5)), degtorad(-120)];
elseif t < 0.3
    ...
    instructions(3,:) = [double(h.right_leg_joints(3)), degtorad(-130)];
    instructions(4,:) = [double(h.left_leg_joints(3)), degtorad(-130)];
    ...
    % Feet
    instructions(7,:) = [double(h.right_leg_joints(5)), degtorad(-22)];
    instructions(8,:) = [double(h.left_leg_joints(5)), degtorad(-22)];
 else
    % Phase 4 Stand up
    instructions(1,:) = [double(h.right_leg_joints(3)), degtorad(-40)];
    instructions(2,:) = [double(h.left_leg_joints(3)), degtorad(-40)];
