...
elseif t < 2.8
    % Time to stand
    % right leg
    instructions(1,:) = [double(h.right_leg(3)), degtorad(-90)];
    instructions(2,:) = [double(h.right_leg(4)), degtorad(60)];
    instructions(3,:) = [double(h.right_leg(5)), degtorad(-10)];
...
elseif t < 3.2
    % right leg
    instructions(1,:) = [double(h.right_leg(3)), degtorad(-70)];
    instructions(2,:) = [double(h.right_leg(4)), degtorad(50)];
    instructions(3,:) = [double(h.right_leg(5)), degtorad(-10)];
    ...
    % right leg
    instructions(1,:) = [double(h.right_leg(3)), degtorad(-50)];
    instructions(2,:) = [double(h.right_leg(4)), degtorad(40)];
    instructions(3,:) = [double(h.right_leg(5)), degtorad(-8)];
