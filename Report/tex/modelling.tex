...
\begin{lstlisting}[language={[5.0]Lua}, numbers = left, tabsize = 4, frame=single,breaklines, keywordstyle=\color{blue}, float, caption={Control code of the servo}, label={lst:servo}, captionpos = b]
if not PID_P then
    PID_P=0.1
    PID_I=0
    PID_D=0
